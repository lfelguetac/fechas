...
*/
export function addDias ( fecha: string, nDias: number ): string | CodigoFormatoFecha {

    const codigoFormatoFecha: CodigoFormatoFecha = validarFecha(fecha);
    if (codigoFormatoFecha !== CodigoFormatoFecha.FTM_CORRECTO) { return codigoFormatoFecha }
